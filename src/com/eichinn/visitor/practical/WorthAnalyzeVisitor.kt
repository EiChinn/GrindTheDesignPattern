 ...
 */
class WorthAnalyzeVisitor : Visitor{
    override fun visitEnterpriseCustomer(enterpriseCustomer: EnterpriseCustomer) {
        println("Enterprise customer ${enterpriseCustomer.name} worth analyze")
    }

    override fun visitPersonalCustomer(personalCustomer: PersonalCustomer) {
        println("personal customer ${personalCustomer.name} worth analyze")
    }
}